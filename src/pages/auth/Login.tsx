...
function AuthBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0a0f1e 0%, #0f1e38 50%, #071020 100%)' }}>
      ...
      {/* Fade overlay — vignette + center brighten */}
    ...
    <div className="relative h-screen flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm" style={{ background: 'rgba(255,255,255,0.97)', boxShadow: '0 25px 60px rgba(0,0,0,0.5)' }}>
        ...
        <div className="p-8">
          ...
          <h1 className="text-[#111827] text-xl font-semibold mb-1 tracking-tight">Sign in</h1>
          <p className="text-[#6b7280] text-sm mb-6">Enter your credentials to continue</p>
